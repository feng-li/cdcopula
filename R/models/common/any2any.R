#' Translate a distribution to another one (approximately) through link functions.
#'
...
###----------------------------------------------------------------------------
    ...
    else if(tolower(inType) == "gbeta")
    {
        ...
        if(length(a) == 0)
        {
            stop("A lower boundary parameter `a` for gbeta link is expected.")
        }

        if(length(b) == 0)
        {
            stop("An upper boundary parameter `b` for gbeta link is expected.")
        }
    ...
    else if(tolower(inType) == "glognorm")
    {
        ...
        if(length(a) == 0)
        {
            stop("A lower boundary parameter `a > 0` for glognorm input is expected.")
        }
