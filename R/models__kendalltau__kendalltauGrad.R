...
############################################
                ...
                {
                    out.theta[IdxDeltaSmall & Idx12] <- (-(thetaCurr.A^2*(4-2*digamma(1)*(thetaCurr.A-2)
                        +(thetaCurr.A-6)*thetaCurr.A) + 2*(thetaCurr.A-2)*thetaCurr.A^2*digamma(2/thetaCurr.A-1)+
                        4*(thetaCurr.A-2)^2*trigamma((2+thetaCurr.A)/thetaCurr.A))/ ((thetaCurr.A-2)^3*thetaCurr.A^2))
                }
...
############################################
                ...
                out.delta[IdxLarge] <- (-2/((thetaCurr-2)*deltaCurr^2)-
                                        ...
                                        ((2+deltaCurr)*deltaCurr*thetaCurr^2*
                                         sin(2*pi/thetaCurr)* beta(1+deltaCurr+2/thetaCurr, 2-2/thetaCurr)))
