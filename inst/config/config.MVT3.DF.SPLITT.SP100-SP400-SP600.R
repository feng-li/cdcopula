...
Mdl.X[[3]][["mu"]] <- cbind(1, X[[3]][Mdl.dataUsedIdx, 1])
Mdl.X[[3]][["phi"]] <- cbind(1, X[[3]][Mdl.dataUsedIdx, 1])
Mdl.X[[3]][["df"]] <- cbind(1, X[[3]][Mdl.dataUsedIdx, 1])
Mdl.X[[3]][["lmd"]] <- cbind(1, X[[3]][Mdl.dataUsedIdx, 1])

Mdl.X[[4]][["df"]] <- cbind(1, X[[1]][Mdl.dataUsedIdx, 1], X[[2]][Mdl.dataUsedIdx, 1], X[[3]][Mdl.dataUsedIdx, 1])
Mdl.X[[4]][["rho"]] <- cbind(1, X[[1]][Mdl.dataUsedIdx, 1], X[[2]][Mdl.dataUsedIdx, 1], X[[3]][Mdl.dataUsedIdx, 1])
...
Mdl.parLink[[3]][["phi"]] <- list(type = "glog", a = 0.01, b = 100, nPar = 1)
Mdl.parLink[[3]][["df"]] <- list(type = "glog", nPar = 1, a = 2, b = 30)
Mdl.parLink[[3]][["lmd"]] <- list(type = "glog", a = 0.01, b = 100, nPar = 1)
...
MCMC.varSelArgs[[4]][["df"]] <- list(cand = "2:end", init = "all-in")
MCMC.varSelArgs[[4]][["rho"]] <- list(cand = "2:end", init = "all-in")
...
## density. A variable "MCMC.density[["u"]]" must provide. "MCMC.density" consists of CDF
## of margins (i.e. u1, u2, ...)
...
Mdl.priArgs[[3]][["mu"]] <- list("beta" = list("intercept" = list(type = "custom",
                                                                  input = list(type = "norm",  mean = 0, variance = 1),
                                                                  output = list(type = "norm", shrinkage = 1)),
                                               "slopes" = list(type = "cond-mvnorm",
                                                               mean = 0, covariance = "identity", shrinkage = 1)),
                                 "indicators" = list(type = "bern", prob = 0.5))
Mdl.priArgs[[3]][["phi"]] <- list("beta" = list("intercept" = list(type = "custom",
                                                                   input = list(type = "glognorm",  mean = 1, variance = 1, a = 0.01),
                                                                   output = list(type = "norm", shrinkage = 1)),
                                                "slopes" = list(type = "cond-mvnorm",
                                                                mean = 0, covariance = "identity", shrinkage = 1)),
...
Mdl.priArgs[[3]][["df"]] <- list("beta" = list("intercept" = list(type = "custom",
                                               ...
                                               "slopes" = list(type = "cond-mvnorm",
                                                               mean = 0, covariance = "identity", shrinkage = 1)),
                                 "indicators" = list(type = "bern", prob = 0.5))
Mdl.priArgs[[3]][["lmd"]] <- list("beta" = list("intercept" = list(type = "custom",
                                                                   input = list(type = "glognorm",  mean = 1, variance = 1, a = 0.01),
                                                                   output = list(type = "norm", shrinkage = 1)),
                                                "slopes" = list(type = "cond-mvnorm",
                                                                mean = 0, covariance = "identity", shrinkage = 1)),
...
Mdl.priArgs[[4]][["df"]] <- list("beta" = list("intercept" = list(type = "custom",
                                                                  input = list(type = "glognorm",  mean = 5, variance = 10, a = 4),
                                                                  output = list(type = "norm", shrinkage = 1)),
                                               "slopes" = list(type = "cond-mvnorm",
                                                               mean = 0, covariance = "identity", shrinkage = 1)),
