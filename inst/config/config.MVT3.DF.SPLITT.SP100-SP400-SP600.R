...
Mdl.X <- MCMCUpdate
Mdl.X[[1]][["mu"]] <- cbind(1, X[[1]][dataUsedIdx, 1])
Mdl.X[[1]][["phi"]] <- cbind(1, X[[1]][dataUsedIdx, 1])
Mdl.X[[1]][["df"]] <- cbind(1, X[[1]][dataUsedIdx, 1])
Mdl.X[[1]][["lmd"]] <- cbind(1, X[[1]][dataUsedIdx, 1])

Mdl.X[[2]][["mu"]] <- cbind(1, X[[2]][dataUsedIdx, 1])
Mdl.X[[2]][["phi"]] <- cbind(1, X[[2]][dataUsedIdx, 1])
Mdl.X[[2]][["df"]] <- cbind(1, X[[2]][dataUsedIdx, 1])
Mdl.X[[2]][["lmd"]] <- cbind(1, X[[2]][dataUsedIdx, 1])

Mdl.X[[3]][["mu"]] <- cbind(1, X[[3]][dataUsedIdx, 1])
Mdl.X[[3]][["phi"]] <- cbind(1, X[[3]][dataUsedIdx, 1])
Mdl.X[[3]][["df"]] <- cbind(1, X[[3]][dataUsedIdx, 1])
Mdl.X[[3]][["lmd"]] <- cbind(1, X[[3]][dataUsedIdx, 1])

Mdl.X[[4]][["df"]] <- cbind(1, X[[1]][dataUsedIdx, 1], X[[2]][dataUsedIdx, 1], X[[3]][dataUsedIdx, 1])
Mdl.X[[4]][["rho"]] <- cbind(1, X[[1]][dataUsedIdx, 1], X[[2]][dataUsedIdx, 1], X[[3]][dataUsedIdx, 1])
...
varSelArgs[[4]][["df"]] <- list(cand = "2:end", init = "all-in")
varSelArgs[[4]][["rho"]] <- list(cand = "2:end", init = "all-in")
...
nCross <- 1
crossValidArgs <- list(N.subsets = nCross, partiMethod = "time-series", testRatio = 0.2)
