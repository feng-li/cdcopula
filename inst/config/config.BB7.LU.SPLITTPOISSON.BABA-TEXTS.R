...
Mdl.X[[2]][["mu"]] <- cbind(1, X[[2]][nObsIdx, 1:10])
...
varSelArgs[[2]][["mu"]] <- list(cand = 2:10, init = "all-out")

varSelArgs[[3]][["lambdaL"]] <- list(cand = 2:19, init = "all-in")
varSelArgs[[3]][["lambdaU"]] <- list(cand = 2:19, init = "all-in")
