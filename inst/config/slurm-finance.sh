...
#SBATCH --mail-user=liangzhenghua@foxmail.com
...
srun ~/students/2017210748liangzhenghua/code/cdcopula/inst/bin/CplRun ~/students/2017210748liangzhenghua/code/cdcopula/inst/config/${CONFIG_FILE}

## SEND RESULTS
cat JOB${SLURM_JOB_ID}.out JOB${SLURM_JOB_ID}.err |\
/usr/bin/mail -s "JOB${SLURM_JOB_ID}.${SLURM_JOB_NAME}(${CONFIG_FILE})" liangzhenghua@foxmail.com
