...
load(file.path(CDCOPULA_LIB_ROOT_DIR, "data/CNSTOCKS.Rdata"))
...
Mdl.X <- MCMC.Update
Mdl.X[[1]][["mu"]] <- cbind(1, X[[1]][Mdl.dataUsedIdx, 1:9])#[, 1, drop = FALSE]
Mdl.X[[1]][["phi"]] <- cbind(1, X[[1]][Mdl.dataUsedIdx, 1:9])#[, 1, drop = FALSE]
Mdl.X[[1]][["df"]] <- cbind(1, X[[1]][Mdl.dataUsedIdx, 1:9])#[, 1, drop = FALSE]
Mdl.X[[1]][["lmd"]] <- cbind(1, X[[1]][Mdl.dataUsedIdx, 1:9])#[, 1, drop = FALSE]

Mdl.X[[2]][["mu"]] <- cbind(1, X[[2]][Mdl.dataUsedIdx, 1:9])#[, 1, drop = FALSE]
Mdl.X[[2]][["phi"]] <- cbind(1, X[[2]][Mdl.dataUsedIdx, 1:9])#[, 1, drop = FALSE]
Mdl.X[[2]][["df"]] <- cbind(1, X[[2]][Mdl.dataUsedIdx, 1:9])#[, 1, drop = FALSE]
Mdl.X[[2]][["lmd"]] <- cbind(1, X[[2]][Mdl.dataUsedIdx, 1:9])#[, 1, drop = FALSE]
