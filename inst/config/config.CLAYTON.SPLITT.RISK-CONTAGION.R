...
Mdl.MargisType <- c("SPLITT", "SPLITT", "CLAYTON")


## Mdl.MargisNM <- c("000021", "000066", "CLAYTON")
## Mdl.MargisNM <- c("000021", "600755", "CLAYTON")
Mdl.MargisNM <- c("000066", "600755", "CLAYTON")
...
## NONE COVARIATES SELECTION
## Mdl.varSelArgs[[3]][["lambdaL"]] <- list(cand = NULL, init = "all-out")
