...
##  Mdl.MargisNM <- c("CH", "RS", "BB7")
## Mdl.MargisNM <- c("CH", "PL", "BB7")
## Mdl.MargisNM <- c("CH", "GM", "BB7")
## Mdl.MargisNM <- c("CH", "CZ", "BB7")
## Mdl.MargisNM <- c("CH", "FR", "BB7")
## Mdl.MargisNM <- c("CH", "ES", "BB7")
## Mdl.MargisNM <- c("CH", "BL", "BB7")

## Mdl.MargisNM <- c("RS", "PL", "BB7")
## Mdl.MargisNM <- c("RS", "GM", "BB7")
## Mdl.MargisNM <- c("RS", "CZ", "BB7")
## Mdl.MargisNM <- c("RS", "FR", "BB7")
## Mdl.MargisNM <- c("RS", "ES", "BB7")
Mdl.MargisNM <- c("RS", "BL", "BB7")

## Mdl.MargisNM <- c("PL", "GM", "BB7")
## Mdl.MargisNM <- c("PL", "CZ", "BB7")
## Mdl.MargisNM <- c("PL", "FR", "BB7")
## Mdl.MargisNM <- c("PL", "ES", "BB7")
## Mdl.MargisNM <- c("PL", "BL", "BB7")

## Mdl.MargisNM <- c("GM", "CZ", "BB7")
## Mdl.MargisNM <- c("GM", "FR", "BB7")
## Mdl.MargisNM <- c("GM", "ES", "BB7")
## Mdl.MargisNM <- c("GM", "BL", "BB7")

## Mdl.MargisNM <- c("CZ", "FR", "BB7")
## Mdl.MargisNM <- c("CZ", "ES", "BB7")
## Mdl.MargisNM <- c("CZ", "BL", "BB7")

## Mdl.MargisNM <- c("FR", "ES", "BB7")
## Mdl.MargisNM <- c("FR", "BL", "BB7")

## Mdl.MargisNM <- c("ES", "BL", "BB7")
...
source(file.path(CDCOPULA_LIB_ROOT_DIR, "inst/scripts/Get-Market-Integration.R"))
...
Mdl.X[[3]][["tau"]] <- cbind(1, X[[3]])[Mdl.dataUsedIdx, ]
...
## Mdl.X[[3]][["tau"]] <- matrix(1, length(Mdl.dataUsedIdx), 1)
...
## Mdl.varSelArgs[[3]][["tau"]] <- list(cand = NULL, inst = "all-out")
