...
Mdl.MargisType <- c("SPLITT", "SPLITT", "GUMBEL")

## Mdl.MargisNM <- c("000021", "000066", "GUMBEL")
## Mdl.MargisNM <- c("000021", "600755", "GUMBEL")
Mdl.MargisNM <- c("000066", "600755", "GUMBEL")

## Mdl.MargisNM <- c("000021", "000032", "GUMBEL")
## Mdl.MargisNM <- c("000021", "000727", "GUMBEL")
## Mdl.MargisNM <- c("000021", "000748", "GUMBEL")
## Mdl.MargisNM <- c("000021", "600171", "GUMBEL")
## Mdl.MargisNM <- c("000021", "600536", "GUMBEL")
## Mdl.MargisNM <- c("000021", "600764", "GUMBEL")
## Mdl.MargisNM <- c("000021", "600775", "GUMBEL")

## Mdl.MargisNM <- c("000032", "000066", "GUMBEL")
## Mdl.MargisNM <- c("000032", "000727", "GUMBEL")
## Mdl.MargisNM <- c("000032", "000748", "GUMBEL")
## Mdl.MargisNM <- c("000032", "600171", "GUMBEL")
## Mdl.MargisNM <- c("000032", "600536", "GUMBEL")
## Mdl.MargisNM <- c("000032", "600755", "GUMBEL")
## Mdl.MargisNM <- c("000032", "600764", "GUMBEL")
## Mdl.MargisNM <- c("000032", "600775", "GUMBEL")

## Mdl.MargisNM <- c("000066", "000727", "GUMBEL")
## Mdl.MargisNM <- c("000066", "000748", "GUMBEL")
## Mdl.MargisNM <- c("000066", "600171", "GUMBEL")
## Mdl.MargisNM <- c("000066", "600536", "GUMBEL")
## Mdl.MargisNM <- c("000066", "600764", "GUMBEL")
## Mdl.MargisNM <- c("000066", "600775", "GUMBEL")

## Mdl.MargisNM <- c("000727", "000748", "GUMBEL")
## Mdl.MargisNM <- c("000727", "600755", "GUMBEL")
## Mdl.MargisNM <- c("000727", "600764", "GUMBEL")

## Mdl.MargisNM <- c("000748", "600171", "GUMBEL")
## Mdl.MargisNM <- c("000748", "600536", "GUMBEL")
## Mdl.MargisNM <- c("000748", "600755", "GUMBEL")
## Mdl.MargisNM <- c("000748", "600764", "GUMBEL")
## Mdl.MargisNM <- c("000748", "600775", "GUMBEL")

## Mdl.MargisNM <- c("600171", "600755", "GUMBEL")
## Mdl.MargisNM <- c("600171", "600764", "GUMBEL")

## Mdl.MargisNM <- c("600536", "600755", "GUMBEL")
## Mdl.MargisNM <- c("600536", "600764", "GUMBEL")

## Mdl.MargisNM <- c("600755", "600764", "GUMBEL")
## Mdl.MargisNM <- c("600755", "600775", "GUMBEL")

## Mdl.MargisNM <- c("600764", "600775", "GUMBEL")
...
## NONE COVARIATES FOR COPULA PARAMETERS
...
Mdl.parLink[[3]][["lambdaU"]] <- list(type = "glogit", a = 0.01, b = 0.99, nPar = 1)
...
## NONE COVARIATE SELECTION
## Mdl.varSelArgs[[3]][["lambdaU"]] <- list(cand = NULL, init = "all-out")
