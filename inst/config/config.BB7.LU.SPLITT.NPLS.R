...
###----------------------------------------------------------------------------
### SPECIFY FOR DIFFERENT MODEL RUNNING
###----------------------------------------------------------------------------
##Mdl.MargisNM <- c("real_estate", "city_bank", "BB7")
##Mdl.MargisNM <- c("real_estate", "joint_bank", "BB7")
##Mdl.MargisNM <- c("real_estate", "state_bank", "BB7")
##Mdl.MargisNM <- c("manufracture", "city_bank", "BB7")
##Mdl.MargisNM <- c("manufracture", "joint_bank", "BB7")
Mdl.MargisNM <- c("manufracture", "state_bank", "mixed")



MCMC.Update <- list(list("mu" = F, "phi" = T, "df" = T, "lmd" = T),
                   list("mu" = F, "phi" = T, "df" = T, "lmd" = T),
...
source(file.path(CDCOPULA_LIB_ROOT_DIR, "inst/scripts/Get-NPLS.R"))
...
Mdl.X <- MCMC.Update
Mdl.X[[1]][["mu"]] <- matrix(1, length(Mdl.dataUsedIdx), 1)
Mdl.X[[1]][["phi"]] <- matrix(1, length(Mdl.dataUsedIdx), 1)
Mdl.X[[1]][["df"]] <- matrix(1, length(Mdl.dataUsedIdx), 1)
Mdl.X[[1]][["lmd"]] <- matrix(1, length(Mdl.dataUsedIdx), 1)

Mdl.X[[2]][["mu"]] <- matrix(1, length(Mdl.dataUsedIdx), 1)
Mdl.X[[2]][["phi"]] <- matrix(1, length(Mdl.dataUsedIdx), 1)
Mdl.X[[2]][["df"]] <- matrix(1, length(Mdl.dataUsedIdx), 1)
Mdl.X[[2]][["lmd"]] <- matrix(1, length(Mdl.dataUsedIdx), 1)
...
Mdl.varSelArgs[[1]][["mu"]] <- list(cand = NULL, init = "all-out")
Mdl.varSelArgs[[1]][["phi"]] <- list(cand = NULL, init = "all-out")
Mdl.varSelArgs[[1]][["df"]] <- list(cand = NULL, init = "all-out")
Mdl.varSelArgs[[1]][["lmd"]] <- list(cand = NULL, init = "all-out")

Mdl.varSelArgs[[2]][["mu"]] <- list(cand = NULL, init = "all-out")
Mdl.varSelArgs[[2]][["phi"]] <- list(cand = NULL, init = "all-out")
Mdl.varSelArgs[[2]][["df"]] <- list(cand = NULL, init = "all-out")
Mdl.varSelArgs[[2]][["lmd"]] <- list(cand = NULL, init = "all-out")
