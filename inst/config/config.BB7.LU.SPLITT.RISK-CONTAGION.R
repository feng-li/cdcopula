...
##Mdl.MargisType <- c("SPLITT", "SPLITT", "BB7_90")

###----------------------------------------------------------------------------
### SPECIFIC FOR DIFFERENT MARGIN MODEL
###----------------------------------------------------------------------------

## Mdl.MargisNM <- c("002017", "600130", "BB7")
## Mdl.MargisNM <- c("002017", "600680", "BB7")
## Mdl.MargisNM <- c("002017", "600776", "BB7")
## Mdl.MargisNM <- c("600130", "600680", "BB7")
## Mdl.MargisNM <- c("600130", "600776", "BB7")
## Mdl.MargisNM <- c("600680", "600776", "BB7")

## Mdl.MargisNM <- c("000014", "600330", "BB7")
## Mdl.MargisNM <- c("000014", "600850", "BB7")
## Mdl.MargisNM <- c("000014", "600990", "BB7")
## Mdl.MargisNM <- c("600330", "600850", "BB7")
## Mdl.MargisNM <- c("600330", "600990", "BB7")
## Mdl.MargisNM <- c("600850", "600990", "BB7")

###------------------------------------------------
###  CEC TEXT PART MODEL SPECIFICATION
###------------------------------------------------
...
###--------------------------------------------------
## APPENDIX PART MODEL SPECIFICATION
###------------------------------------------------

## Mdl.MargisNM <- c("000021", "000032", "BB7")
## Mdl.MargisNM <- c("000021", "000727", "BB7")
## Mdl.MargisNM <- c("000021", "000748", "BB7")
## Mdl.MargisNM <- c("000021", "600171", "BB7")
## Mdl.MargisNM <- c("000021", "600536", "BB7")
## Mdl.MargisNM <- c("000021", "600764", "BB7")
## Mdl.MargisNM <- c("000021", "600775", "BB7")

## Mdl.MargisNM <- c("000032", "000066", "BB7")
## Mdl.MargisNM <- c("000032", "000727", "BB7")
## Mdl.MargisNM <- c("000032", "000748", "BB7")
## Mdl.MargisNM <- c("000032", "600171", "BB7")
## Mdl.MargisNM <- c("000032", "600536", "BB7")
## Mdl.MargisNM <- c("000032", "600755", "BB7")
## Mdl.MargisNM <- c("000032", "600764", "BB7")
## Mdl.MargisNM <- c("000032", "600775", "BB7")

## Mdl.MargisNM <- c("000066", "000727", "BB7")
## Mdl.MargisNM <- c("000066", "000748", "BB7")
## Mdl.MargisNM <- c("000066", "600171", "BB7")
## Mdl.MargisNM <- c("000066", "600536", "BB7")
## Mdl.MargisNM <- c("000066", "600764", "BB7")
## Mdl.MargisNM <- c("000066", "600775", "BB7")

## Mdl.MargisNM <- c("000727", "000748", "BB7")
## Mdl.MargisNM <- c("000727", "600171", "BB7")
## Mdl.MargisNM <- c("000727", "600536", "BB7")
## Mdl.MargisNM <- c("000727", "600755", "BB7")
## Mdl.MargisNM <- c("000727", "600764", "BB7")
## Mdl.MargisNM <- c("000727", "600775", "BB7")

## Mdl.MargisNM <- c("000748", "600171", "BB7")
## Mdl.MargisNM <- c("000748", "600536", "BB7")
## Mdl.MargisNM <- c("000748", "600755", "BB7")
## Mdl.MargisNM <- c("000748", "600764", "BB7")
## Mdl.MargisNM <- c("000748", "600775", "BB7")

## Mdl.MargisNM <- c("600171", "600536", "BB7")
## Mdl.MargisNM <- c("600171", "600755", "BB7")
## Mdl.MargisNM <- c("600171", "600764", "BB7")
## Mdl.MargisNM <- c("600171", "600775", "BB7")

## Mdl.MargisNM <- c("600536", "600755", "BB7")
## Mdl.MargisNM <- c("600536", "600764", "BB7")
## Mdl.MargisNM <- c("600536", "600775", "BB7")

## Mdl.MargisNM <- c("600755", "600764", "BB7")
## Mdl.MargisNM <- c("600755", "600775", "BB7")

## Mdl.MargisNM <- c("600764", "600775", "BB7")

#######################################################
##   ROTATE 90 BB7
#######################################################

##Mdl.MargisNM <- c("000021", "000032", "mixed")
##Mdl.MargisNM <- c("000021", "000727", "mixed")
##Mdl.MargisNM <- c("000021", "000748", "mixed")
##Mdl.MargisNM <- c("000021", "600764", "mixed")
##Mdl.MargisNM <- c("000021", "600775", "mixed")

##Mdl.MargisNM <- c("000032", "000066", "mixed")
##Mdl.MargisNM <- c("000032", "600755", "mixed")

##Mdl.MargisNM <- c("000066", "000727", "mixed")
##Mdl.MargisNM <- c("000066", "000748", "mixed")
##Mdl.MargisNM <- c("000066", "600171", "mixed")
##Mdl.MargisNM <- c("000066", "600764", "mixed")
##Mdl.MargisNM <- c("000066", "600775", "mixed")

##Mdl.MargisNM <- c("000727", "000748", "mixed")
##Mdl.MargisNM <- c("000727", "600171", "mixed")
##Mdl.MargisNM <- c("000727", "600536", "mixed")
##Mdl.MargisNM <- c("000727", "600755", "mixed")

##Mdl.MargisNM <- c("000748", "600755", "mixed")

##Mdl.MargisNM <- c("600171", "600775", "mixed")

##Mdl.MargisNM <- c("600755", "600764", "mixed")
##Mdl.MargisNM <- c("600755", "600775", "mixed")
...
Mdl.X <- MCMC.Update
Mdl.X[[1]][["mu"]] <- cbind(1, X[[1]])[Mdl.dataUsedIdx, ]
Mdl.X[[1]][["phi"]] <- cbind(1, X[[1]])[Mdl.dataUsedIdx, ]
Mdl.X[[1]][["df"]] <- cbind(1, X[[1]])[Mdl.dataUsedIdx, ]
Mdl.X[[1]][["lmd"]] <- cbind(1, X[[1]])[Mdl.dataUsedIdx, ]

Mdl.X[[2]][["mu"]] <- cbind(1, X[[2]])[Mdl.dataUsedIdx, ]
Mdl.X[[2]][["phi"]] <- cbind(1, X[[2]])[Mdl.dataUsedIdx, ]
Mdl.X[[2]][["df"]] <- cbind(1, X[[2]])[Mdl.dataUsedIdx, ]
Mdl.X[[2]][["lmd"]] <- cbind(1, X[[2]])[Mdl.dataUsedIdx, ]
...
## NONE COVARIATE SELECTING FOR COPULA PARAMETERS
## Mdl.varSelArgs[[3]][["lambdaL"]] <- list(cand = NULL, inst = "all-out")
## Mdl.varSelArgs[[3]][["lambdaU"]] <- list(cand = NULL, inst = "all-out")
...
## nCross <- 0  # full sample trainning
nCross <- 1       # 80% training sample 20% testing sample--out-of-sample prediction
...
Mdl.priArgs[[1]][["mu"]] <- list("beta" = list("intercept" = list(type = "custom",
...
Mdl.priArgs[[1]][["phi"]] <- list("beta" = list("intercept" = list(type = "custom",
                                            ...
                                            "slopes" = list(type = "cond-mvnorm",
                                                            mean = 0, covariance = "identity", shrinkage = 1)),
                              "indicators" = list(type = "beta", alpha = 1, beta = 1))
Mdl.priArgs[[1]][["df"]] <- list("beta" = list("intercept" = list(type = "custom",
...
Mdl.priArgs[[2]][["mu"]] <- list("beta" = list("intercept" = list(type = "custom",
                                                              input = list(type = "norm",  mean = 0, variance = 1),
                                                              output = list(type = "norm", shrinkage = 1)),
                                           "slopes" = list(type = "cond-mvnorm",
                                                           mean = 0, covariance = "identity", shrinkage = 1)),
...
Mdl.priArgs[[2]][["phi"]] <- list("beta" = list("intercept" = list(type = "custom",
                                            ...
                                            "slopes" = list(type = "cond-mvnorm",
                                                            mean = 0, covariance = "identity", shrinkage = 1)),
                              "indicators" = list(type = "beta", alpha = 1, beta = 1))
Mdl.priArgs[[2]][["df"]] <- list("beta" = list("intercept" = list(type = "custom",
                                                              input = list(type = "glognorm",  mean = 5, variance = 10, a = 2),
                                                              output = list(type = "norm", shrinkage = 1)),
                                           "slopes" = list(type = "cond-mvnorm",
                                                           mean = 0, covariance = "identity", shrinkage = 1)),
...
Mdl.priArgs[[3]][["lambdaL"]] <- list("beta" = list("intercept" = list(type = "custom",
                                                ...
                                                "slopes" = list(type = "cond-mvnorm",
                                                                mean = 0, covariance = "identity", shrinkage = 1)),
                                  "indicators" = list(type = "beta", alpha = 1, beta = 1))
Mdl.priArgs[[3]][["lambdaU"]] <- list("beta" = list("intercept" = list(type = "custom",
                                                                   input = list(type = "gbeta",  mean = 0.2, variance = 0.05,
                                                                                a = 0.01, b = 0.99),
                                                                   output = list(type = "norm", shrinkage = 1)),
                                                "slopes" = list(type = "cond-mvnorm",
